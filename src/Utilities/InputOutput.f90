...
module InputOutputModule
  ...
  public :: GetUnit, u8rdcom, uget_block, &
            ...
            get_nwords, u9rdcom, save_particle_track_datum
...
! ------------------------------------------------------------------------------
                                ...
                                !> @brief Save a row of particle tracking data
            subroutine save_particle_track_datum(btrkun, csv, kper, kstp, prpid, &
                                       partid, cellid, status, reason, t, x, y, z)
                                  implicit none
                                  ! -- dummy
                                  integer(I4B), intent(in) :: btrkun
                                  logical(LGP), intent(in) :: csv
                                  integer(I4B), intent(in) :: kper, kstp
                 integer(I4B), intent(in) :: prpid, partid, cellid, status, reason
                     ...
                     kper, kstp, prpid, partid, cellid, status, reason, t, x, y, z
                                ...
                                end subroutine save_particle_track_datum
